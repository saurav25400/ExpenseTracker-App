...
class ExpenseRepository {
  ...
  // //first delete the old tage by seraching oldTag in nested array
  // const db=getDB();
  // await db.collection(this.collectionName).updateOne({_id:new ObjectId(id)},{$pull:{
  //   tags:oldTag
  // }})

  // //after removing add the new tag in the tag array

  // const result=await db.collection(this.collectionName).updateOne({_id:new ObjectId(id)},{$push:{tags:newTag}}); 
